const config = {
    ...
    users: {
        ownerId: '419485173558804481', // The bot owner ID, which is you.
        developers: ['419485173558804481'] // The bot developers, remember to include your account ID with the other account IDs.
    },
